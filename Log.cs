...
namespace BoboTech.Logger
{
    ...
    public class Log
    {
        static readonly Lazy<Log> instance = new Lazy<Log>(() => new Log());

        /// <summary>
        /// Singleton instance
        /// </summary>
        internal static Log Instance => instance.Value;
        ...
        Log()
        {
            ...
            var fileTarget = new FileTarget
            {
                ...
                Layout = Layout.FromString("${longdate} ${pad:padding=5:inner=${level}} [${threadid}] ${caller}: ${message}${onexception:inner=${newline}${errorId} ${exception:format=toString}}")
            };
